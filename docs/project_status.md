...
- 赛事日历正式填充：`2026-07-06` 已完成生产线上验收，并开始按“官方源优先、本地语言优先、先 CSV dry-run 再正式导入”的流程写生产库。日本已用 JRA 日文重赏一覧导入 2026 年中央 G1/G2/G3/J-G1/J-G2/J-G3 共 `140` 场，导入结果 `created=139 updated=1 aliases=413`；香港已用 HKJC 繁中 G2/G3 页、活动中心 G1 子赛事与本地赛果页导入 2026 年 1-7 月已公开 G1/G2/G3 共 `19` 场，导入结果 `created=19 updated=0 aliases=74`。生产当前 `RaceEvent=163`、`RaceEventAlias=497`，其中日本 2026 为 `140` 场，香港 2026 为 `20` 条（含既有香港杯样例 1 条）。前台 `/races/`、`/races/?tab=all&region=hong_kong`、日本/香港抽样详情页均返回 `200`；出走表和赛果详情仍未批量导入，详情页按 MVP 展示“暂无出马表”。美国、英国、法国 2026 批次尚未导入。
