## 2026-09-18 赛事线上验收与回填收口（仍有缺口）

历史132场中129场、1209行已回填、重放及主域名逐页验证；828/830缺正式标记，924缺有效发布授权。未来22场中JRA3场名单已公开；另外9场赛时与77条审核候选已入库，双域名18页赛时通过，但名单待PR205新版本。仍缺10场，原因逐项列于[验收记录](changes/complete-race-gaps-20260918/acceptance.md)，不宣称全部补齐。频率维持3h/1h/10min。旧生产d0bb40fb未更新为PR205；新应用合并/发布被自动审批阻止，待精确发布包确认。
