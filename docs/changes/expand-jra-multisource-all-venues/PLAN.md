...
1. **生产已证明**：中山（104/105/107 登记+闭环）、阪神（103/106 登记+闭环）。
...
3. **结构级 proof（已于 2026-09-27 完成）**：札幌/函館/福島/新潟/小倉。以各马场 2026 年已完赛 G 级赛官方结果页（datafile）验证：页头日期/回数/马场名可解析、马场名唯一命中 venue_aliases、赛果表完整。证据包 `structural-proof.json` SHA-256 `e2816af905c7b6f488d6802c6a0dea927c278ef973fbad9d44fb0b82e7f76f45`（8/8 通过，页面 SHA 逐场在案）。这些马场的下一场 2026 赛事为福島記念（11/21），其 CNAME 级 proof 在约 11/17 出马表发布后补齐；札幌/函館/新潟/小倉 2026 年内无更多重赏。
