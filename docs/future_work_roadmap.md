...
| 新一批测试/并发修复 | #195 相关 31 项、#196 相关 43 pass/2 条 macOS skip 及实际 PG 并发通过；#197 相关 2 项、#198 26 项、#199 两模块 30 项加 2 条保护测试通过，各自 45 项发布专项与正式指纹一致；全量仍失败 | #198 四项 CI 作业已核验全部结束；后续整合需以新 main 重新核验实际组合，不累计独立候选计数。#195–199 均未合并部署 |
