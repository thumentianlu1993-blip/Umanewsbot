...
- [修复计划](changes/fix-race-section-gaps/PLAN.md)按举办地日期解释 D−4 起点，用户已将 D−4～D−2／D−1／比赛日三档频率确定为 3 小时／1 小时／10 分钟，取代初版 30／15／5 分钟建议。日历口径及限定 JRA 自动预填仍是实现提案，不冒充用户逐项批准；实施需验证来源能力、请求预算和与现有 owner 的衔接。
