...
MIDDLEWARE = [
    ...
    "stable.middleware.InternalSiteOnlyMiddleware",
...
SITE_INTERNAL_ONLY_ENABLED = env_bool("SITE_INTERNAL_ONLY_ENABLED", True)
SITE_INTERNAL_ONLY_EXEMPT_PATHS = env_list(
    "SITE_INTERNAL_ONLY_EXEMPT_PATHS",
    "/admin/login/,/django-admin/login/,/healthz/,/robots.txt",
)
SITE_INTERNAL_ONLY_TRUSTED_TLS_TERMINATION = env_bool(
    "SITE_INTERNAL_ONLY_TRUSTED_TLS_TERMINATION",
    False,
)
NEWS_EXTERNAL_AI_PROCESSING_ENABLED = env_bool(
    "NEWS_EXTERNAL_AI_PROCESSING_ENABLED",
    False,
)
OSS_PRIVATE_MEDIA_ENABLED = env_bool("OSS_PRIVATE_MEDIA_ENABLED", False)
OSS_PRIVATE_MEDIA_URL_TTL_SECONDS = max(
    1,
    int(env("OSS_PRIVATE_MEDIA_URL_TTL_SECONDS", "300")),
)
...
NEW_REGION_NEWS_ATTRIBUTION_CANDIDATES_ENABLED = env_bool(
    "NEW_REGION_NEWS_ATTRIBUTION_CANDIDATES_ENABLED",
    False,
)
NEW_REGION_NEWS_ATTRIBUTION_CANDIDATE_SOURCES = env_list(
    "NEW_REGION_NEWS_ATTRIBUTION_CANDIDATE_SOURCES",
    "",
)
MULTIREGION_CONTENT_SCOPED_CANDIDATES_ENABLED = env_bool(
    "MULTIREGION_CONTENT_SCOPED_CANDIDATES_ENABLED",
    False,
)
MULTIREGION_CONTENT_SCOPED_CANDIDATE_SOURCES = env_list(
...
NEWS_SOURCE_PERMISSION_PREFLIGHT_ENFORCEMENT_ENABLED = env_bool(
