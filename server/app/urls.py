...
urlpatterns = [
    ...
    path("horses/<int:profile_id>/", stable_views.public_horse_detail, name="public-horse-detail"),
    path("horses/<int:profile_id>/follow/", stable_views.public_horse_follow, name="public-horse-follow"),
