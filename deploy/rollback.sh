...
# This generic path is B-to-B only: it keeps 0074 applied. Validate the target
...
COMPOSE_FILE="$COMPOSE_FILE" EXPECTED_CANDIDATE_COMMIT="$TARGET_OID" \
  ...
  RELEASE_B_EXPECTED_MIGRATION_LEAF_SET=stable.0074_race_data_sync_r0_control_plane \
